...
//        addSequential(new ErrorAuto("autonomous mode LeftSideRightScaleAuto not completed."));
    	...
    	addSequential(new HighGearGyroDrive(219000,0,1,true)); // (340000) drive forward initially
...
//    				new MoveElevator(3),new PivotIntake('d'),new WaitCommand(0.2)}));
    	...
    	addSequential(new LowGearGyroDrive(34000,200));  //29000
    	...
    	addSequential(new WaitCommand(0.5));
    	addSequential(new LowGearGyroArc(52500,0));  //38000
