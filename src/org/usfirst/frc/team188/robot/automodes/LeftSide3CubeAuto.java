...
public class LeftSide3CubeAuto extends CommandGroup {
    ...
    public LeftSide3CubeAuto() {
	    ...
	    addSequential(new HighGearGyroDrive(249000, 0)); //initial sprint forward
	    ...
	    addSequential(new WaitCommand(0.5));                                   //LOOK HERE
	    ...
	    addSequential(new LowGearGyroDrive(61000, 148));
	    addSequential(new MoveIntake(-0.55,1));                                //LOOK HERE
	    ...
	    addSequential(new MoveIntake(-0.9,-0.4, 1.2));                         //LOOK HERE
